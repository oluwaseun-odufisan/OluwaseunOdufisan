    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h1
                    ref={titleRef}
                    className="text-6xl sm:text-8xl font-poppins font-extrabold text-teal-primary mb-6 animate-float"
                ...
                <p
                    ref={messageRef}
                    className="text-xl sm:text-2xl font-inter text-gray-accent mb-8"
                >
